...
if(EXISTS "G:/gitRepositories/libigl_CGAL_openGL/external/.cache/glad/glad-download-prefix/src/glad-download-stamp/glad-download-gitclone-lastrun.txt" AND EXISTS "G:/gitRepositories/libigl_CGAL_openGL/external/.cache/glad/glad-download-prefix/src/glad-download-stamp/glad-download-gitinfo.txt" AND
  "G:/gitRepositories/libigl_CGAL_openGL/external/.cache/glad/glad-download-prefix/src/glad-download-stamp/glad-download-gitclone-lastrun.txt" IS_NEWER_THAN "G:/gitRepositories/libigl_CGAL_openGL/external/.cache/glad/glad-download-prefix/src/glad-download-stamp/glad-download-gitinfo.txt")
  message(STATUS
...
while(error_code AND number_of_tries LESS 3)
  execute_process(
    COMMAND "D:/Git/cmd/git.exe"
            clone --no-checkout --config "advice.detachedHead=false" --config "advice.detachedHead=false" -c http.sslVerify=false "https://github.com/libigl/libigl-glad.git" "glad"
...
#
execute_process(
  COMMAND ${CMAKE_COMMAND} -E copy "G:/gitRepositories/libigl_CGAL_openGL/external/.cache/glad/glad-download-prefix/src/glad-download-stamp/glad-download-gitinfo.txt" "G:/gitRepositories/libigl_CGAL_openGL/external/.cache/glad/glad-download-prefix/src/glad-download-stamp/glad-download-gitclone-lastrun.txt"
  RESULT_VARIABLE error_code
)
if(error_code)
