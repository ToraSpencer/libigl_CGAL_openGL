...
execute_process(
  COMMAND "D:/Git/cmd/git.exe" --git-dir=.git show-ref "19cedf96d70702d8b3a83eb27934780c542356fe"
  WORKING_DIRECTORY "G:/gitRepositories/libigl_CGAL_openGL/cmake/../external/../tests/data"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"19cedf96d70702d8b3a83eb27934780c542356fe\" is not present locally, and not "
