...
execute_process(
  COMMAND "D:/Git/cmd/git.exe" show-ref "3ee6cac2230f0fe1413879574f741c7b6da11221"
  WORKING_DIRECTORY "E:/gitRepositories/libigl_CGAL_openGL/cmake/../external/triangle"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/gitRepositories/libigl_CGAL_openGL/cmake/../external/triangle'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/gitRepositories/libigl_CGAL_openGL/cmake/../external/triangle'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
