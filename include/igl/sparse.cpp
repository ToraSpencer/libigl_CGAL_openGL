  ...
  Eigen::SparseMatrix<T>& X)
{
  ...
  return igl::sparse(I,J,vers,m,n,X);
}
  ...
  Eigen::SparseMatrix<T>& X)
{
  ...
  //for(int i = 0;i < nv;i++)
  //{
  //  dyn_X.coeffRef((int)I(i),(int)J(i)) += (T)vers(i);
  //}
  ...
  {
    IJV.push_back(Triplet<T >(I(x),J(x),vers(x)));
  }
  X.resize(m,n);
