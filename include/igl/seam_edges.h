...
namespace igl
{
  ...
  //
  // Inputs:
  //   vers  #vers by dim list of positions of the input mesh.
  //   TC  #TC by 2 list of 2D texture coordinates of the input mesh
  //   tris  #tris by 3 list of triange indices into vers representing a
  //     manifold-with-boundary triangle mesh
  //   FTC  #tris by 3 list of indices into TC for each corner
  // Outputs:
  ...
  //         tris[ seams( i, 0 ), seams( i, 1 ) ], tris[ seams( i, 0 ), (seams( i, 1 ) + 1) % 3 ]
  //     and the other side is the edge:
  //         tris[ seams( i, 2 ), seams( i, 3 ) ], tris[ seams( i, 2 ), (seams( i, 3 ) + 1) % 3 ]
  ...
  //         tris[ boundaries( i, 0 ), boundaries( i, 1 ) ], tris[ boundaries( i, 0 ), (boundaries( i, 1 ) + 1) % 3 ]
  ...
  //       tris[ foldovers( i, 0 ), foldovers( i, 1 ) ], tris[ foldovers( i, 0 ), (foldovers( i, 1 ) + 1) % 3 ]
  //     and the other side is the edge:
  //       tris[ foldovers( i, 2 ), foldovers( i, 3 ) ], tris[ foldovers( i, 2 ), (foldovers( i, 3 ) + 1) % 3 ]
  template <
    typename DerivedV, 
    typename DerivedTC,
    typename DerivedF, 
