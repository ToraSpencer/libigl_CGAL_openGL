...
namespace igl
{
  ...
  // function expects that the given mesh (vers,Ele) has sufficient samples
  // (vertices) exactly at point handle locations and exactly along bone and
  // cage edges.
  //
  // Inputs:
  //   vers  #vers by dim list of domain vertices
  ...
  // Outputs:
  //   b  #b list of boundary indices (indices into vers of vertices which have
  //     known, fixed values)
