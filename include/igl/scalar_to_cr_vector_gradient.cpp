                                  ...
                                  Eigen::SparseMatrix<ScalarG>& G)
{
  ...
  scalar_to_cr_vector_gradient_intrinsic(tris, l_sq, E, oE, G);
}
                                  ...
                                  Eigen::SparseMatrix<ScalarG>& G)
{
  ...
  scalar_to_cr_vector_gradient(vers, tris, cE, coE, G);
}
                                            ...
                                            Eigen::SparseMatrix<ScalarG>& G)
{
  ...
  scalar_to_cr_vector_gradient_intrinsic(tris, l_sq, dA, E, oE, G);
}
