...
// GL_ARRAY_BUFFER for the vertex positions (vers) and one
...
namespace igl
{
  namespace opengl
  {
    ...
    //
    // NOTE: when using glDrawElements VBOs for vers and F using MatrixXd and
    ...
    //   vers  #vers by 3 eigen Matrix of mesh vertex 3D positions
    //   F  #F by 3 eigen Matrix of face (triangle) indices
    //   N  #vers by 3 eigen Matrix of mesh vertex 3D normals
    // Outputs:
    //   V_vbo_id  buffer id for vertex positions
    //   F_vbo_id  buffer id for face indices
