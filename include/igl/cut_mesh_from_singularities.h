...
namespace igl
{
  // Given a mesh (vers,tris) and the integer mismatch of a cross field per edge
  ...
  //   mismatch  #tris by 3 list of per corner integer mismatch
  // Outputs:
  //   seams  #tris by 3 list of per corner booleans that denotes if an edge is a
  //     seam or not
  //
  template <
    typename DerivedV, 
