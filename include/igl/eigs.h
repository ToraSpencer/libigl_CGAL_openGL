...
namespace igl
{
    ...
    /*
       ...
       Outputs:
         eigVecs  #A by k list of sorted eigen vectors (descending)
         eigValues  k list of sorted eigen values (descending)
  ...
  */   
  ...
  IGL_INLINE bool eigs(
    ...
    const size_t k,
    const EigsType type,
    Eigen::PlainObjectBase<DerivedU> & eigVecs,
    Eigen::PlainObjectBase<DerivedS> & eigValues);
}
