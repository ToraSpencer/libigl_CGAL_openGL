...
// Different optimizations of my and Ben Trumbore's  code from journals of graphics tools (JGT)       
...
// Alec: I've added an include guard, made all functions inline and added IGL_RAY_TRI_ to #define macros
...
// code rewritten to do tests on the sign of the determinant  the division is before the test of the sign of the det    
