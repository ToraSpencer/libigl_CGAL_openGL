...
namespace igl
{
  ...
  //   PD2in      #tris by 3 eigen Matrix of the second per face cross field vector
  // Output:
  //   PD1out      #tris by 3 eigen Matrix of the first combed cross field vector
  //   PD2out      #tris by 3 eigen Matrix of the second combed cross field vector
  //
  
  
  template <typename DerivedV, typename DerivedF>
  IGL_INLINE void comb_cross_field(const Eigen::MatrixBase<DerivedV> &vers,
