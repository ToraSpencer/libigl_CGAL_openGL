...
namespace igl
{
  // Given a triangle mesh (vers,tris) compute a new mesh (VV,FF) which contains the
  // original faces and vertices of (vers,tris) except any small triangles have been
  ...
  //     diagonal
  // Outputs:
  //   FF  #FF by 3 list of triangle indices into vers
  //
  //
