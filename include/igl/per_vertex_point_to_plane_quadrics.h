...
namespace igl
{
  // Compute quadrics per vertex of a "closed" triangle mesh (vers,tris). Rather than
  // follow the qslim paper, this implements the lesser-known _follow up_
  // "Simplifying Surfaces with Color and Texture using Quadric Error Metrics".
  // This allows vers to be n-dimensional (where the extra coordiantes store
  ...
  // Outputs:
  //   quadrics  #vers list of quadrics, where a quadric is a tuple {A,b,c} such
